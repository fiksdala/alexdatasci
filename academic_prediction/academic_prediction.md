...
\*I've recently noticed that github doesn't correctly render LaTeX equations as they are written in .Rmd files. There also does not appear to be a solution. If I find a solution in the future, I'll make adjustments, but for now, there's nothing to be done. Sorry for the inconvenience.
